        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 rounded-xl bg-[#f1f1f6] hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">Discover special dishes and exclusive offers from top restaurants in your area.</p>
            </div>
            <div className="p-6 rounded-xl bg-[#f1f1f6] hover:shadow-lg transition-shadow">
              <Users className="w-12 h-12 text-[#4c4c96] mb-4" />
              <h3 className="text-xl font-semibold mb-3">Community Reviews</h3>
              <p className="text-gray-600">Access authentic reviews and ratings from fellow food enthusiasts.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 rounded-xl bg-white/10 backdrop-blur hover:bg-white/20 transition-colors">
              ...
              <p className="text-white/80">Visualize customer engagement and optimize your menu accordingly.</p>
            </div>
            <div className="p-6 rounded-xl bg-white/10 backdrop-blur hover:bg-white/20 transition-colors">
              <TrendingUp className="w-12 h-12 mb-4" />
              <h3 className="text-xl font-semibold mb-3">Marketing Tools</h3>
              <p className="text-white/80">Launch AI-driven campaigns and receive weekly performance reports.</p>
            </div>
          </div>
